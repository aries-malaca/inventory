  ...
  <div class="login-box-body">
    ...
    <div>
      <div class="form-group has-feedback">
        <input @keypress="tapLogin" type="email" v-model="user.email" class="form-control" placeholder="Email">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input @keypress="tapLogin" type="password" v-model="user.password" class="form-control" placeholder="Password">
